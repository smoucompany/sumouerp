            ...
            {users.map((user) => (
              <div key={user.id} className="p-6 rounded-[3.5rem] bg-white/[0.02] border border-white/5 hover:border-secondary/20 transition-all group relative overflow-hidden flex flex-col md:flex-row items-center gap-8">
                 ...
                 <div className="flex-1 w-full space-y-4">
                    <div>
                       <h4 className="font-black text-xl text-white mb-1">{user.fullName}</h4>
                 ...
                 <button onClick={() => removeItem(user.id!)} className="absolute top-8 left-8 p-3 text-rose-500 opacity-0 group-hover:opacity-100 transition-all hover:bg-rose-500/10 rounded-xl">
                    <Trash2 size={20} />
                 </button>
              </div>
            ))}
        ...
        <div className="p-2">
           ...
           <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-6">
                 ...
                 <div className="space-y-5 text-right">
                    <label className="text-sm font-black text-white/20 uppercase tracking-[0.2em] px-6">البريد الإلكتروني المهني</label>
                    <div className="relative group">
                       <input 
                 ...
                 <div className="space-y-5 text-right">
                    <label className="text-sm font-black text-white/20 uppercase tracking-[0.2em] px-6">كلمة المرور المؤقتة</label>
                    <div className="relative group">
                       <input 
                 ...
                 <div className="space-y-5 text-right relative z-50">
                    <label className="text-sm font-black text-white/20 uppercase tracking-[0.2em] px-6">صلاحية النظام</label>
                    <CustomSelect 
                 ...
                 <div className="space-y-5 text-right relative z-40">
                    <label className="text-sm font-black text-white/20 uppercase tracking-[0.2em] px-6">ربط بملف موظف (اختياري)</label>
                    <CustomSelect 
                 ...
                 <div className="space-y-5 text-right relative z-30">
                    <label className="text-sm font-black text-white/20 uppercase tracking-[0.2em] px-6">الحالة التشغيلية</label>
                    <CustomSelect 
